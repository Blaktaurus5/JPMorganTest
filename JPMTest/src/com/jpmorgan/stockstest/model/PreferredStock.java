 ...
 * 
 *         Class that models a preferred stock
 * 
 */
public class PreferredStock implements Stock {
	...
	/**
	 * Default constructor for a preferred stock.
	 * @param _symbol symbol of the stock.
	 * @param _lastDividend last dividend of the stock.
	 * @param _type type of the stock, has to be StockType.PREFERRED.
	 * @param _price price of the stock.
	 * @param _parValue par value of the stock.
	 * @param _fixedDividend fixed dividend (in percentage) of the stock.
	 */
	public PreferredStock(String _symbol, double _lastDividend,
			StockType _type, double _price, double _parValue, double _fixedDividend)
			throws StockTypeException {
		
		if(!_type.equals(StockType.PREFERRED)) throw new StockTypeException();
		this.symbol = _symbol;
		this.lastDividend = _lastDividend;
		this.fixedDividend = _fixedDividend;
		this.type = _type;
	...
	public void setFixedDividend(double _fixedDividend) {
		this.fixedDividend = _fixedDividend;
	}
